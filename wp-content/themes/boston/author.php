...
get_header(); ?>
<?php if(isset($boston_redux_demo['auth_bg']['url']) && $boston_redux_demo['auth_bg']['url'] != ''){?>
<section class="section bg-gray pt-200 bg-img" style="background-image: url('<?php echo esc_url($boston_redux_demo['auth_bg']['url']); ?>');">
<?php }else{?>
		...
		<div class="row section-heading">
			<div class="col-lg-12">
				<h3 class="text-center">
					<?php if(isset($boston_redux_demo['auth_title']) && $boston_redux_demo['auth_title']!=''){?>
						<span><?php echo esc_attr($boston_redux_demo['auth_title']);?></span>
					<?php }else{?>
						<span><?php echo esc_html__( 'All post by author', 'boston' );?></span>
					<?php } ?>
					<span class="cap"><?php printf( esc_html__( ' %s', 'boston' ), get_the_author() );?></span>
				</h3>
			</div>
		</div>
	</div>
