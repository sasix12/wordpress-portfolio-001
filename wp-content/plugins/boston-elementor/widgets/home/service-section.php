	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => __( 'Enter your text title', 'bdevs-elementor' ),
				'default'     => __( 'Services I Offer', 'bdevs-elementor' ),
				'label_block' => true,
			]
		);
		$this->add_control(
			'tabs',
			[
				'label' => esc_html__( 'Services Content Item', 'bdevs-elementor' ),
				...
				<div class="col-sm-6 col-lg-4">
					<div class="feature-box-01">
						<div class="feature-content">
							<?php if ($i < 10) { ?>
								<div class="number"><span><?php echo "0" ?><?php echo esc_attr($i) ; ?></span></div>
							<?php } else { ?>
								<div class="number"><span><?php echo esc_attr($i) ; ?></span></div>
							<?php } ?>
							...
							<?php if ('' != $item['icon_item']): ?>
								<div class="icon"><?php echo wp_kses_post($item['icon_item']); ?></div>
							<?php endif ?>
						</div>
					</div>
				</div>
