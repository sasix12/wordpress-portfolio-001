	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default'     => __( 'Our friendly team would love to hear from you.', 'bdevs-elementor' ),
				'label_block' => true,
			]
		);
		$this->add_control(
			...
			[
				...
				'default'     => __( '[contact-form-7 id="177" title="Contact Form"]', 'bdevs-elementor' ),
				'label_block' => true,
			]
		);
...
<div class="contact-form">
	...
	<?php if ('' != $settings['subtitle']): ?>
		<p class="lead"><?php echo wp_kses_post($settings['subtitle']); ?></p>
	<?php endif ?>
