...
class BdevsPortfolioSection extends \Elementor\Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'tabs',
			[
				'label' => esc_html__( 'Portfolio Content Item', 'bdevs-elementor' ),
			...
			<div class="portfolio-box">
				<?php if ('' != $item['image_item']['url']): ?>
					<div class="portfolio-img">
						<a href="<?php echo wp_kses_post($item['image_item']['url']); ?>" class="gallery-link">
				...
				<div class="portfolio-info">
					...
					<?php if ('' != $item['link_item']): ?>
						<a href="<?php echo wp_kses_post($item['link_item']); ?>" class="gallery-link">
