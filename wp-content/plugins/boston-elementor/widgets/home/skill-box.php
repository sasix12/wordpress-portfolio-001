 ...
 * @since 1.0.0
 */
class BdevsSkillBox extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Skill Box', 'bdevs-elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_content_skill_box',
			[
				'label' => esc_html__( 'Skill Box', 'bdevs-elementor' ),
			]
		);
		$this->add_control(
			'title',
		...
		$this->add_control(
			'tabs',
			[
				'label' => esc_html__( 'Skill Box Content Item', 'bdevs-elementor' ),
...
<div class="skill-box">
	...
	<div class="row g-3">
		...
		?>
			<?php if (('' != $item['icon_item']) || ('' != $item['title_item'])): ?>
				<div class="col-6 col-md-4 col-lg-6">
					<div class="feature-box-02">
						...
						<?php if ('' != $item['title_item']): ?>
							<h6><?php echo wp_kses_post($item['title_item']); ?></h6>
						<?php endif ?>
					</div>
				</div>
			<?php endif ?>
